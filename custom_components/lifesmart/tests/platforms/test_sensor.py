...
class TestSensorSetup:
    ...
    async def test_setup_creates_correct_entities(
        ...
        # 验证平台实体数量
        # 验证平台实体数量和设备数量一致性
        verify_platform_entity_count(hass, "sensor", mock_lifesmart_devices)
        assert_platform_entity_count_matches_devices(
            hass, "sensor", mock_lifesmart_devices
        )
    ...
    async def test_setup_respects_exclusions(
        ...
        unique_id_excluded_hub = generate_unique_id(
            excluded_device_on_hub[lifesmart_const.DEVICE_TYPE_KEY],
            excluded_device_on_hub[lifesmart_const.HUB_ID_KEY],
            excluded_device_on_hub[lifesmart_const.DEVICE_ID_KEY],
            "T",
        )
        assert (
            entity_registry.async_get_entity_id(
                "sensor", lifesmart_const.DOMAIN, unique_id_excluded_hub
            )
            is None
        ), "被排除的设备不应该创建传感器实体"
...
class TestSensorEntity:
    ...
    async def test_sensor_becomes_unavailable(
        ...
        # 模拟设备从API响应中消失
        device_list = hass.data[lifesmart_const.DOMAIN][
            setup_integration_sensor_only.entry_id
        ]["devices"]
        hass.data[lifesmart_const.DOMAIN][setup_integration_sensor_only.entry_id][
            "devices"
        ] = [
            d
            for d in device_list
            if d.get(lifesmart_const.DEVICE_ID_KEY) != "sensor_env"
        ]
    ...
    async def test_sensor_update_from_dispatcher(
        ...
        unique_id = generate_unique_id(
            raw_device[lifesmart_const.DEVICE_TYPE_KEY],
            raw_device[lifesmart_const.HUB_ID_KEY],
            raw_device[lifesmart_const.DEVICE_ID_KEY],
            sub_key,
        )

        async_dispatcher_send(
            hass,
            f"{lifesmart_const.LIFESMART_SIGNAL_UPDATE_ENTITY}_{unique_id}",
            update_payload,
        )
        await hass.async_block_till_done()
...
class TestSensorAdvancedScenarios:
    ...
    async def test_sensor_device_class_determination_edge_cases(
        ...
        # 测试环境传感器的温度子键
        temp_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Environment Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env1",
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 250, "type": 1}},
        }
        ...
        # 测试电池传感器
        battery_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_LOCK",
            lifesmart_const.DEVICE_NAME_KEY: "Smart Lock",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "lock1",
            lifesmart_const.DEVICE_DATA_KEY: {"BAT": {"val": 85, "type": 1}},
        }
    ...
    async def test_sensor_unit_determination_comprehensive(
        ...
        temp_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Temperature Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "temp1",
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 250, "type": 1}},
        }
        temp_sensor = LifeSmartSensor(
            raw_device=temp_device,
        ...
        humidity_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Humidity Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "hum1",
            lifesmart_const.DEVICE_DATA_KEY: {"H": {"val": 60, "type": 1}},
        }
    ...
    async def test_sensor_value_conversion_comprehensive(
        ...
        humidity_device = {
            ...
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env1",
            lifesmart_const.DEVICE_DATA_KEY: {"H": {"val": 650, "type": 1}},
        }
        humidity_sensor = LifeSmartSensor(
            raw_device=humidity_device,
            client=MagicMock(),
        ...
        small_humidity_device = {
            ...
            lifesmart_const.DEVICE_NAME_KEY: "Environment Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env2",
            lifesmart_const.DEVICE_DATA_KEY: {"H": {"val": 45, "type": 1}},
        }
        ...
        # 测试气候设备的特殊数值转换
        climate_temp_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_CP_DN",
            lifesmart_const.DEVICE_NAME_KEY: "Climate",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "climate1",
            lifesmart_const.DEVICE_DATA_KEY: {"P5": {"val": 235, "type": 1}},
        }
    ...
    async def test_sensor_extra_attributes(
        ...
        temp_device = {
            ...
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "temp1",
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 25, "type": 1}},
        }
        temp_sensor = LifeSmartSensor(
            raw_device=temp_device,
            client=MagicMock(),
        ...
        co2_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_CA",
            lifesmart_const.DEVICE_NAME_KEY: "CO2 Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "co2_1",
            lifesmart_const.DEVICE_DATA_KEY: {"P3": {"val": 2, "type": 1}},
        }
    ...
    async def test_sensor_name_generation(
        ...
        device_with_sub_name = {
            ...
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env1",
            lifesmart_const.DEVICE_DATA_KEY: {
                "T": {"name": "Temperature", "val": 25, "type": 1}
            },
        }
        ...
        device_same_name = {
            ...
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env2",
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"name": "T", "val": 25, "type": 1}},
        }
        ...
        device_no_sub_name = {
            ...
            lifesmart_const.DEVICE_NAME_KEY: "Environment Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "env3",
            lifesmart_const.DEVICE_DATA_KEY: {"H": {"val": 60, "type": 1}},
        }
    ...
    async def test_sensor_error_handling_in_updates(
        ...
        # 测试空的更新数据
        async_dispatcher_send(
            hass, f"{lifesmart_const.LIFESMART_SIGNAL_UPDATE_ENTITY}_{unique_id}", {}
        )
        await hass.async_block_till_done()
    ...
    async def test_sensor_global_refresh_error_handling(
        ...
        # 模拟设备数据损坏的情况
        original_devices = hass.data[lifesmart_const.DOMAIN][
            setup_integration_sensor_only.entry_id
        ]["devices"]
        hass.data[lifesmart_const.DOMAIN][setup_integration_sensor_only.entry_id][
            "devices"
    ...
    async def test_sensor_state_class_comprehensive(
        ...
        energy_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_OE_3C",
            lifesmart_const.DEVICE_NAME_KEY: "Energy Meter",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "meter1",
            lifesmart_const.DEVICE_DATA_KEY: {"P2": {"val": 15, "type": 1}},
        }
        ...
        generic_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Generic Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "generic1",
            lifesmart_const.DEVICE_DATA_KEY: {"UNKNOWN": {"val": 100, "type": 1}},
        }
    ...
    async def test_sensor_entity_unknown_device_class(
        ...
        # 测试未知子键的传感器
        unknown_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "UNKNOWN_TYPE",
            lifesmart_const.DEVICE_NAME_KEY: "Unknown Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "unknown1",
            lifesmart_const.DEVICE_DATA_KEY: {"UNKNOWN_KEY": {"val": 100, "type": 1}},
        }
    ...
    async def test_sensor_entity_unknown_unit_measurement(
        ...
        unknown_unit_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Unknown Unit Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "unknown_unit1",
            lifesmart_const.DEVICE_DATA_KEY: {"UNKNOWN_UNIT": {"val": 50, "type": 1}},
        }
    ...
    async def test_sensor_entity_unknown_state_class(
        ...
        unknown_state_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "UNKNOWN_TYPE",
            lifesmart_const.DEVICE_NAME_KEY: "Unknown State Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "unknown_state1",
            lifesmart_const.DEVICE_DATA_KEY: {"UNKNOWN_STATE": {"val": 25, "type": 1}},
        }
    ...
    async def test_sensor_value_conversion_boundary_cases(
        ...
        humidity_100_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Humidity 100 Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "h100",
            lifesmart_const.DEVICE_DATA_KEY: {"H": {"val": 100, "type": 1}},
        }
        ...
        for device_type in temp_device_types:
            temp_device = {
                lifesmart_const.DEVICE_TYPE_KEY: device_type,
                lifesmart_const.DEVICE_NAME_KEY: f"Temp Sensor {device_type}",
                lifesmart_const.HUB_ID_KEY: "hub1",
                lifesmart_const.DEVICE_ID_KEY: f"temp_{device_type}",
                lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 235, "type": 1}},
            }
    ...
    async def test_sensor_special_climate_value_conversion(
        ...
        climate_p4_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_CP_DN",
            lifesmart_const.DEVICE_NAME_KEY: "Climate P4 Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "climate_p4",
            lifesmart_const.DEVICE_DATA_KEY: {"P4": {"val": 245, "type": 1}},
        }
        ...
        climate_p5_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_CP_DN",
            lifesmart_const.DEVICE_NAME_KEY: "Climate P5 Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "climate_p5",
            lifesmart_const.DEVICE_DATA_KEY: {"P5": {"val": 285, "type": 1}},
        }
    ...
    async def test_sensor_voltage_value_direct_conversion(
        ...
        voltage_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Voltage Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "voltage1",
            lifesmart_const.DEVICE_DATA_KEY: {"V": {"val": 95, "type": 1}},
        }
    ...
    async def test_sensor_co2_conversion_scenarios(
        ...
        co2_small_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_CA",
            lifesmart_const.DEVICE_NAME_KEY: "CO2 Small Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "co2_small",
            lifesmart_const.DEVICE_DATA_KEY: {"P3": {"val": 8, "type": 1}},
        }
        ...
        co2_large_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_CA",
            lifesmart_const.DEVICE_NAME_KEY: "CO2 Large Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "co2_large",
            lifesmart_const.DEVICE_DATA_KEY: {"P3": {"val": 15, "type": 1}},
        }
    ...
    async def test_sensor_default_value_no_conversion(
        ...
        default_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_LOCK",
            lifesmart_const.DEVICE_NAME_KEY: "Default Sensor",
            lifesmart_const.HUB_ID_KEY: "hub1",
            lifesmart_const.DEVICE_ID_KEY: "default1",
            lifesmart_const.DEVICE_DATA_KEY: {"BAT": {"val": 88, "type": 1}},
        }
    ...
    async def test_sensor_availability_check_missing_device(
        ...
        test_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Test Sensor",
            lifesmart_const.HUB_ID_KEY: "missing_hub",  # 不在设备列表中的hub
            lifesmart_const.DEVICE_ID_KEY: "missing_device",  # 不在设备列表中的设备
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 25, "type": 1}},
        }
        ...
        hass.data[lifesmart_const.DOMAIN][setup_integration_sensor_only.entry_id][
            ...
            {
                lifesmart_const.HUB_ID_KEY: "other_hub",
                lifesmart_const.DEVICE_ID_KEY: "other_device",
            }
        ]
    ...
    async def test_sensor_global_refresh_missing_device(
        ...
        hass.data[lifesmart_const.DOMAIN][setup_integration_sensor_only.entry_id][
            ...
            if not (
                d.get(lifesmart_const.DEVICE_ID_KEY) == "sensor_env"
                and d.get(lifesmart_const.HUB_ID_KEY) == "hub_sensor"
            )
        ]
    ...
    async def test_sensor_global_refresh_missing_subkey(
        ...
        for device in original_devices:
            if device.get(lifesmart_const.DEVICE_ID_KEY) == "sensor_env":
                # 移除T子键，但保留其他子键
                modified_device = device.copy()
                if lifesmart_const.DEVICE_DATA_KEY in modified_device:
                    modified_device[lifesmart_const.DEVICE_DATA_KEY] = {
                        k: v
                        for k, v in modified_device[
                            lifesmart_const.DEVICE_DATA_KEY
                        ].items()
                        if k != "T"
                    }
    ...
    async def test_sensor_entity_available_check(
        ...
        test_device = {
            lifesmart_const.DEVICE_TYPE_KEY: "SL_SC_EV",
            lifesmart_const.DEVICE_NAME_KEY: "Test Sensor",
            lifesmart_const.HUB_ID_KEY: "missing_hub2",  # 不在设备列表中的hub
            lifesmart_const.DEVICE_ID_KEY: "missing_device2",  # 不在设备列表中的设备
            lifesmart_const.DEVICE_DATA_KEY: {"T": {"val": 25, "type": 1}},
        }
    ...
    async def test_sensor_device_class_edge_cases(
        ...
        for device_type, sub_key, expected_class in test_cases:
            device = {
                lifesmart_const.DEVICE_TYPE_KEY: device_type,
                lifesmart_const.DEVICE_NAME_KEY: f"Test {device_type} {sub_key}",
                lifesmart_const.HUB_ID_KEY: "hub1",
                lifesmart_const.DEVICE_ID_KEY: f"test_{device_type}_{sub_key}",
                lifesmart_const.DEVICE_DATA_KEY: {sub_key: {"val": 100, "type": 1}},
            }
