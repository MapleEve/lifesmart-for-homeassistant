"""Test for LifeSmart local web client module."""
...
class TestLocalWebClientModule:
    """Test cases for local web client module."""
    ...
    def test_logger_creation(self):
        ...
        assert local_web_client._LOGGER.name == "custom_components.lifesmart.core.local_web_client"
