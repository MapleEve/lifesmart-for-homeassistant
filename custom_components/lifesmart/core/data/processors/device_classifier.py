...
class DeviceClassifier:
    ...
    def _classify_control_device(
        ...
        # no-legacy policy: missing/ambiguous condition evidence must not silently
        # choose free_mode or any other default mode.
        _LOGGER.debug("Control device could not be classified strictly")
        return None
