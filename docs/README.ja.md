...
<img src="./assets/ja/hero.gif" alt="LifeSmart IoT Home Assistant インテグレーション" width="100%" />
...
<img src="./assets/ja/overview.gif" alt="LifeSmart インテグレーション概要" width="100%" />
...
<img src="./assets/ja/features.gif" alt="機能" width="100%" />
...
<img src="./assets/ja/installation.gif" alt="HACSからのインストール" width="100%" />
...
<img src="./assets/ja/initialization.gif" alt="初期設定" width="100%" />
...
<img src="./assets/ja/usage.gif" alt="Home Assistantサービス" width="100%" />
...
<img src="./assets/ja/devices.gif" alt="対応デバイス" width="100%" />
...
<img src="./assets/ja/compatibility.gif" alt="互換性とテスト" width="100%" />
...
<img src="./assets/ja/contributing.gif" alt="開発とコントリビューション" width="100%" />
